...
/**
 * This is the model class for table "publicidadarticulos".
 *
 * The followings are the available columns in table 'publicidadarticulos':
 ...
 */
class Publicidadarticulos extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return Publicidadarticulos the static model class
	 */
