...
/**
 * This is the model class for table "bienvenidos".
 *
 * The followings are the available columns in table 'bienvenidos':
 * @property integer $idbienvenido
 ...
 */
class Bienvenidos extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return Bienvenidos the static model class
	 */
	...
	public function rules()
	{
		...
		return array(
			...
			array('idbienvenido, titulo, titulo_seo, subtitulo, contenido, fuente, fecha_publicacion, activo, created, modified', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('idbienvenido',$this->idbienvenido);
