...
/**
 * This is the model class for table "publicidadnovedades".
 *
 * The followings are the available columns in table 'publicidadnovedades':
 ...
 */
class Publicidadnovedades extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return Publicidadnovedades the static model class
	 */
