...
/**
 * This is the model class for table "galeria_videos".
 *
 * The followings are the available columns in table 'galeria_videos':
 ...
 */
class GaleriaVideos extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return GaleriaVideos the static model class
	 */
	...
	public function rules()
	{
		...
		return array(
			...
			array('activo, home', 'numerical', 'integerOnly'=>true),
			array('titulo, titulo_seo', 'length', 'max'=>45),
			array('url', 'length', 'max'=>20),
			array('autor', 'length', 'max'=>255),
			array('descripcion,autor', 'length', 'allowEmpty'=>true),
                        array('prioridad', 'default', 'setOnEmpty' => true, 'value' => NULL),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('idgaleria, titulo, titulo_seo, autor, url, descripcion, activo, created, modified', 'safe', 'on'=>'search'),
		);
	}
