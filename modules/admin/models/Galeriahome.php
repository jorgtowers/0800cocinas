...
/**
 * This is the model class for table "galeriahome".
 *
 * The followings are the available columns in table 'galeriahome':
 ...
 */
class Galeriahome extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return Galeriahome the static model class
	 */
	...
	public function rules()
	{
		...
		return array(
			...
			array('idgaleria, titulo, titulo_seo, contenido, activo, created, modified', 'safe', 'on'=>'search'),
		);
	}
