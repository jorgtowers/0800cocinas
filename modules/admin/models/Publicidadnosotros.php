...
/**
 * This is the model class for table "publicidadnosotros".
 *
 * The followings are the available columns in table 'publicidadnosotros':
 ...
 */
class Publicidadnosotros extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return Publicidadnosotros the static model class
	 */
