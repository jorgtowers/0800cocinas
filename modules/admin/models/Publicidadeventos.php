...
/**
 * This is the model class for table "publicidadeventos".
 *
 * The followings are the available columns in table 'publicidadeventos':
 ...
 */
class Publicidadeventos extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return Publicidadeventos the static model class
	 */
