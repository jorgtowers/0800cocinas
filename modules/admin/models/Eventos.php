...
class Eventos extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('titulo, titulo_seo, fuente, fecha_publicacion', 'length', 'max'=>45),
			array('subtitulo', 'length', 'max'=>100),
			array('fecha_evento', 'safe'),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('idevento, titulo, titulo_seo, subtitulo, contenido, fuente, fecha_publicacion, fecha_evento, activo, created, modified', 'safe', 'on'=>'search'),
		);
	}
