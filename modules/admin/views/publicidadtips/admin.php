...
$('.search-form form').submit(function(){
	$('#publicidadtips-grid').yiiGridView('update', {
		data: $(this).serialize()
	});
	return false;
});
...
<div class="page-header position-relative">
	<h1>
		Galería Publicidad Tips<?php echo CHtml::link('Nuevo',array('/admin/publicidadtips/create'),array('class'=>'button btn btn-primary','style'=>'float:right')); ?>
	</h1>
