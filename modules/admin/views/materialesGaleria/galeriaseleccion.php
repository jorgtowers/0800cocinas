...
$this->breadcrumbs=array(
	'Materiales Galerías'=>array('admin'),
...
<div class="page-header position-relative">
	<h1>
		Galería Selección - <?php echo ucwords($model->titulo); ?>
	</h1>
</div><!--/.page-header-->

            <?php
            $this->widget( 'xupload.XUpload', array(
                'url' => Yii::app( )->createUrl( "admin/".Yii::app()->getController()->getId()."/uploadseleccion", array("material"=>$material,"id"=>$id)),
            	'url_fotos' => Yii::app( )->createUrl( "admin/".Yii::app()->getController()->getId()."/subidasseleccion", array("material"=>$material,"id"=>$id)),
                //our XUploadForm
                'model' => $photos,
