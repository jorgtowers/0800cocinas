...
<div class="page-header position-relative">
	<h1>
		Galería - <?php echo ucwords($model->titulo); ?>
	</h1>
</div><!--/.page-header-->

            <?php
            $this->widget( 'xupload.XUpload', array(
                'url' => Yii::app( )->createUrl( "admin/".Yii::app()->getController()->getId()."/upload", array("material"=>$material,"id"=>$id)),
            	'url_fotos' => Yii::app( )->createUrl( "admin/".Yii::app()->getController()->getId()."/subidas", array("material"=>$material,"id"=>$id)),
                //our XUploadForm
                'model' => $photos,
