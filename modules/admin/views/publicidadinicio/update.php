...
<div class="page-header position-relative">
	<h1>
		Actualizar Publicidad Inicio #<?php echo $model->idpublicidad; ?><small class="note">Los campos con <span class="required">*</span> son requeridos.</small>
	</h1>
</div><!--/.page-header-->
