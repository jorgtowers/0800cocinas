...
$('.search-form form').submit(function(){
	$('#publicidadnovedades-grid').yiiGridView('update', {
		data: $(this).serialize()
	});
	return false;
});
...
<div class="page-header position-relative">
	<h1>
		Galería Publicidad Novedades<?php echo CHtml::link('Nuevo',array('/admin/publicidadnovedades/create'),array('class'=>'button btn btn-primary','style'=>'float:right')); ?>
	</h1>
