...
$this->breadcrumbs=array(
	'Publicidad Novedades'=>array('admin'),
	'Actualizar',
	$model->idpublicidad,
);
...
<div class="page-header position-relative">
	<h1>
		Actualizar Publicidad Novedades #<?php echo $model->idpublicidad; ?><small class="note">Los campos con <span class="required">*</span> son requeridos.</small>
	</h1>
</div><!--/.page-header-->
