...
$('.search-form form').submit(function(){
	$('#publicidadnosotros-grid').yiiGridView('update', {
		data: $(this).serialize()
	});
	return false;
});
...
<div class="page-header position-relative">
	<h1>
		Galería Publicidad Nosotros<?php echo CHtml::link('Nuevo',array('/admin/publicidadnosotros/create'),array('class'=>'button btn btn-primary','style'=>'float:right')); ?>
	</h1>
