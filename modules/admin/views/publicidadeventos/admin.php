...
$('.search-form form').submit(function(){
	$('#publicidadeventos-grid').yiiGridView('update', {
		data: $(this).serialize()
	});
	return false;
});
...
<div class="page-header position-relative">
	<h1>
		Galería Publicidad Eventos<?php echo CHtml::link('Nuevo',array('/admin/publicidadeventos/create'),array('class'=>'button btn btn-primary','style'=>'float:right')); ?>
	</h1>
