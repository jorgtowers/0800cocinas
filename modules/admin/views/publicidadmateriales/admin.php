...
$('.search-form form').submit(function(){
	$('#publicidadmateriales-grid').yiiGridView('update', {
		data: $(this).serialize()
	});
	return false;
});
...
<div class="page-header position-relative">
	<h1>
		Galería Publicidad Materiales<?php echo CHtml::link('Nuevo',array('/admin/publicidadmateriales/create'),array('class'=>'button btn btn-primary','style'=>'float:right')); ?>
	</h1>
