...
class GaleriaVideosController extends RController
{
	/**
	...
	{
		$model=new GaleriaVideos;

		// Uncomment the following line if AJAX validation is needed
		// $this->performAjaxValidation($model);

		if(isset($_POST['GaleriaVideos']))
		{
			$model->attributes=$_POST['GaleriaVideos'];
	...
	{
		$model=new GaleriaVideos('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['GaleriaVideos']))
			$model->attributes=$_GET['GaleriaVideos'];
	 ...
	 * @return GaleriaVideos the loaded model
	 * @throws CHttpException
	 */
	public function loadModel($id)
	{
		$model=GaleriaVideos::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param GaleriaVideos $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='galeria-videos-form')
		{
