...
class PublicidadmaterialesController extends RController
{
	/**
	...
	{
		$model=new Publicidadmateriales;

		// Uncomment the following line if AJAX validation is needed
		// $this->performAjaxValidation($model);

		if(isset($_POST['Publicidadmateriales']))
		{
			$model->attributes=$_POST['Publicidadmateriales'];
	...
	{
		$model=new Publicidadmateriales('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['Publicidadmateriales']))
			$model->attributes=$_GET['Publicidadmateriales'];
	 ...
	 * @return Publicidadmateriales the loaded model
	 * @throws CHttpException
	 */
	public function loadModel($id)
	{
		$model=Publicidadmateriales::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param Publicidadmateriales $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='publicidadmateriales-form')
		{
