...
class PublicidadarticulosController extends RController
{
	/**
	...
	{
		$model=new Publicidadarticulos;

		// Uncomment the following line if AJAX validation is needed
		// $this->performAjaxValidation($model);

		if(isset($_POST['Publicidadarticulos']))
		{
			$model->attributes=$_POST['Publicidadarticulos'];
	...
	{
		$model=new Publicidadarticulos('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['Publicidadarticulos']))
			$model->attributes=$_GET['Publicidadarticulos'];
	 ...
	 * @return Publicidadarticulos the loaded model
	 * @throws CHttpException
	 */
	public function loadModel($id)
	{
		$model=Publicidadarticulos::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param Publicidadarticulos $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='publicidadarticulos-form')
		{
