...
class PublicidadnosotrosController extends RController
{
	/**
	...
	{
		$model=new Publicidadnosotros;

		// Uncomment the following line if AJAX validation is needed
		// $this->performAjaxValidation($model);

		if(isset($_POST['Publicidadnosotros']))
		{
			$model->attributes=$_POST['Publicidadnosotros'];
	...
	{
		$model=new Publicidadnosotros('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['Publicidadnosotros']))
			$model->attributes=$_GET['Publicidadnosotros'];
	 ...
	 * @return Publicidadnosotros the loaded model
	 * @throws CHttpException
	 */
	public function loadModel($id)
	{
		$model=Publicidadnosotros::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param Publicidadnosotros $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='publicidadnosotros-form')
		{
