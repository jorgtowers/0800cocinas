...
class PublicidadnovedadesController extends RController
{
	/**
	...
	{
		$model=new Publicidadnovedades;

		// Uncomment the following line if AJAX validation is needed
		// $this->performAjaxValidation($model);

		if(isset($_POST['Publicidadnovedades']))
		{
			$model->attributes=$_POST['Publicidadnovedades'];
	...
	{
		$model=new Publicidadnovedades('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['Publicidadnovedades']))
			$model->attributes=$_GET['Publicidadnovedades'];
	 ...
	 * @return Publicidadnovedades the loaded model
	 * @throws CHttpException
	 */
	public function loadModel($id)
	{
		$model=Publicidadnovedades::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param Publicidadnovedades $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='publicidadnovedades-form')
		{
