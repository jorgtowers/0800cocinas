...
class GaleriatopeController extends RController
{
	/**
	...
	public function actionGaleria()
	{
	    ...
	    $folderPath = Yii::app( )->getBasePath( )."/../images/".Yii::app()->getController()->getId()."/thumbs";
	    if (!is_dir($folderPath)){
	    	mkdir($folderPath,0755);
	    }
	    //$publicPath = Yii::app( )->getBaseUrl( )."/images/".Yii::app()->getController()->getId()."/";
	    //$path = realpath( Yii::app( )->getBasePath( )."/../images/".Yii::app()->getController()->getId()."/" )."/";
