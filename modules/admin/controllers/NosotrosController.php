...
class NosotrosController extends RController
{
	/**
	...
	public function actionCreate()
	{
		...
		{
			$model->attributes=$_POST['Nosotros'];
			...
			if($model->save())
				$ch = curl_init();
				$timeout = 5;
				curl_setopt($ch,CURLOPT_URL,'https://api-ssl.bitly.com/v3/shorten?access_token=e08d293b23cb8cca809609186e68aebb8cbf65f0&longUrl='.(urlencode('http://www.0800cocinas.com/nosotros/view/'.$model->idnosotros.'#titulo')).'&format=txt');
	...
	public function actionUpdate($id)
	{
		...
		if(isset($_POST['Nosotros']))
		{
			...
			if ($url != 'http://www.0800cocinas.com/nosotros/view/'.$model->idnosotros.'#titulo' || $model->short_url == ""){
				$ch = curl_init();
				$timeout = 5;
				curl_setopt($ch,CURLOPT_URL,'https://api-ssl.bitly.com/v3/shorten?access_token=e08d293b23cb8cca809609186e68aebb8cbf65f0&longUrl='.(urlencode('http://www.0800cocinas.com/nosotros/view/'.$model->idnosotros.'#titulo')).'&format=txt');
				curl_setopt($ch,CURLOPT_RETURNTRANSFER,1);
	...
	{
		$model=new Nosotros('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['Nosotros']))
			$model->attributes=$_GET['Nosotros'];
	 ...
	 * @param Nosotros $model the model to be validated
	 */
