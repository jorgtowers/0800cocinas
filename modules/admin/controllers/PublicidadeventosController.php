...
class PublicidadeventosController extends RController
{
	/**
	...
	{
		$model=new Publicidadeventos;

		// Uncomment the following line if AJAX validation is needed
		// $this->performAjaxValidation($model);

		if(isset($_POST['Publicidadeventos']))
		{
			$model->attributes=$_POST['Publicidadeventos'];
	...
	{
		$model=new Publicidadeventos('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['Publicidadeventos']))
			$model->attributes=$_GET['Publicidadeventos'];
	 ...
	 * @return Publicidadeventos the loaded model
	 * @throws CHttpException
	 */
	public function loadModel($id)
	{
		$model=Publicidadeventos::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param Publicidadeventos $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='publicidadeventos-form')
		{
