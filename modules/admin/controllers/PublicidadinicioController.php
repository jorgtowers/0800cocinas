...
class PublicidadinicioController extends RController
{
	/**
	...
	{
		$model=new Publicidadinicio;

		// Uncomment the following line if AJAX validation is needed
		// $this->performAjaxValidation($model);

		if(isset($_POST['Publicidadinicio']))
		{
			$model->attributes=$_POST['Publicidadinicio'];
	...
	{
		$model=new Publicidadinicio('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['Publicidadinicio']))
			$model->attributes=$_GET['Publicidadinicio'];
	 ...
	 * @return Publicidadinicio the loaded model
	 * @throws CHttpException
	 */
	public function loadModel($id)
	{
		$model=Publicidadinicio::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param Publicidadinicio $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='publicidadinicio-form')
		{
