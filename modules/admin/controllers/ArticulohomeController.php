...
class ArticulohomeController extends RController
{
	/**
	...
	{
		$model=new Articulohome;

		// Uncomment the following line if AJAX validation is needed
		// $this->performAjaxValidation($model);

		if(isset($_POST['Articulohome']))
		{
			$model->attributes=$_POST['Articulohome'];
			...
			$ch = curl_init();
			$timeout = 5;
			curl_setopt($ch,CURLOPT_URL,'https://api-ssl.bitly.com/v3/shorten?access_token=e08d293b23cb8cca809609186e68aebb8cbf65f0&longUrl='.(urlencode('http://www.0800cocinas.com/'.$model->url)).'&format=txt');
	...
	public function actionUpdate($id)
	{
		...
		if(isset($_POST['Articulohome']))
		{
			if ($model->url != $_POST['Articulohome']['url'] || $model->short_url == ""){
				$ch = curl_init();
				$timeout = 5;
				curl_setopt($ch,CURLOPT_URL,'https://api-ssl.bitly.com/v3/shorten?access_token=e08d293b23cb8cca809609186e68aebb8cbf65f0&longUrl='.(urlencode('http://www.0800cocinas.com/'.$_POST['Articulohome']['url'])).'&format=txt');
				curl_setopt($ch,CURLOPT_RETURNTRANSFER,1);
				curl_setopt($ch,CURLOPT_CONNECTTIMEOUT,$timeout);
				$data = curl_exec($ch);
				if ($data === false){
	...
	{
		$model=new Articulohome('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['Articulohome']))
			$model->attributes=$_GET['Articulohome'];
	 ...
	 * @return Articulohome the loaded model
	 * @throws CHttpException
	 */
	public function loadModel($id)
	{
		$model=Articulohome::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param Articulohome $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='articulohome-form')
		{
