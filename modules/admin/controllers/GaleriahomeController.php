...
class GaleriahomeController extends RController
{
	/**
	...
	{
		$model=new Galeriahome;

		// Uncomment the following line if AJAX validation is needed
		// $this->performAjaxValidation($model);

		if(isset($_POST['Galeriahome']))
		{
			$model->attributes=$_POST['Galeriahome'];
	...
	{
		$model=new Galeriahome('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['Galeriahome']))
			$model->attributes=$_GET['Galeriahome'];
	 ...
	 * @return Galeriahome the loaded model
	 * @throws CHttpException
	 */
	public function loadModel($id)
	{
		$model=Galeriahome::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param Galeriahome $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='galeriahome-form')
		{
