...
class GaleriaEspaciosComplementariosController extends RController
{
	/**
	...
	{
		$model=new GaleriaEspaciosComplementarios;

		// Uncomment the following line if AJAX validation is needed
		// $this->performAjaxValidation($model);

		if(isset($_POST['GaleriaEspaciosComplementarios']))
		{
			$model->attributes=$_POST['GaleriaEspaciosComplementarios'];
	...
	{
		$model=new GaleriaEspaciosComplementarios('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['GaleriaEspaciosComplementarios']))
			$model->attributes=$_GET['GaleriaEspaciosComplementarios'];
	 ...
	 * @return GaleriaEspaciosComplementarios the loaded model
	 * @throws CHttpException
	 */
	public function loadModel($id)
	{
		$model=GaleriaEspaciosComplementarios::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param GaleriaEspaciosComplementarios $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='galeria-espacios-complementarios-form')
		{
