...
class ArticulosController extends RController
{
	/**
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['Articulos']))
		{
			...
			if($model->save())
				$ch = curl_init();
				$timeout = 5;
				curl_setopt($ch,CURLOPT_URL,'https://api-ssl.bitly.com/v3/shorten?access_token=e08d293b23cb8cca809609186e68aebb8cbf65f0&longUrl='.(urlencode('http://www.0800cocinas.com/articulos/view/'.$model->idarticulo.'#titulo')).'&format=txt');
	...
	public function actionUpdate($id)
	{
		...
		if(isset($_POST['Articulos']))
		{
			...
			if ($url != 'http://www.0800cocinas.com/articulos/view/'.$model->idarticulo.'#titulo' || $model->short_url == ""){
				$ch = curl_init();
				$timeout = 5;
				curl_setopt($ch,CURLOPT_URL,'https://api-ssl.bitly.com/v3/shorten?access_token=e08d293b23cb8cca809609186e68aebb8cbf65f0&longUrl='.(urlencode('http://www.0800cocinas.com/articulos/view/'.$model->idarticulo.'#titulo')).'&format=txt');
				curl_setopt($ch,CURLOPT_RETURNTRANSFER,1);
