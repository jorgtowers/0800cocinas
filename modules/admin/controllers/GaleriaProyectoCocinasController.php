...
class GaleriaProyectoCocinasController extends RController
{
	/**
	...
	{
		$model=new GaleriaProyectoCocinas;

		// Uncomment the following line if AJAX validation is needed
		// $this->performAjaxValidation($model);

		if(isset($_POST['GaleriaProyectoCocinas']))
		{
			$model->attributes=$_POST['GaleriaProyectoCocinas'];
	...
	{
		$model=new GaleriaProyectoCocinas('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['GaleriaProyectoCocinas']))
			$model->attributes=$_GET['GaleriaProyectoCocinas'];
	 ...
	 * @return GaleriaProyectoCocinas the loaded model
	 * @throws CHttpException
	 */
	public function loadModel($id)
	{
		$model=GaleriaProyectoCocinas::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param GaleriaProyectoCocinas $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='galeria-proyecto-cocinas-form')
		{
