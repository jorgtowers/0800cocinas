...
class BienvenidosController extends RController
{
	/**
	...
	{
		$model=new Bienvenidos;

		// Uncomment the following line if AJAX validation is needed
		// $this->performAjaxValidation($model);

		if(isset($_POST['Bienvenidos']))
		{
			$model->attributes=$_POST['Bienvenidos'];
	...
	{
		$model=new Bienvenidos('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['Bienvenidos']))
			$model->attributes=$_GET['Bienvenidos'];
	 ...
	 * @return Bienvenidos the loaded model
	 * @throws CHttpException
	 */
	public function loadModel($id)
	{
		$model=Bienvenidos::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param Bienvenidos $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='bienvenidos-form')
		{
