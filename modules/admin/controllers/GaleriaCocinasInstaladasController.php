...
class GaleriaCocinasInstaladasController extends RController
{
	/**
	...
	{
		$model=new GaleriaCocinasInstaladas;

		// Uncomment the following line if AJAX validation is needed
		// $this->performAjaxValidation($model);

		if(isset($_POST['GaleriaCocinasInstaladas']))
		{
			$model->attributes=$_POST['GaleriaCocinasInstaladas'];
	...
	{
		$model=new GaleriaCocinasInstaladas('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['GaleriaCocinasInstaladas']))
			$model->attributes=$_GET['GaleriaCocinasInstaladas'];
	 ...
	 * @return GaleriaCocinasInstaladas the loaded model
	 * @throws CHttpException
	 */
	public function loadModel($id)
	{
		$model=GaleriaCocinasInstaladas::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param GaleriaCocinasInstaladas $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='galeria-cocinas-instaladas-form')
		{
