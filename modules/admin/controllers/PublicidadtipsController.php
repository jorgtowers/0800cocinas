...
class PublicidadtipsController extends RController
{
	/**
	...
	{
		$model=new Publicidadtips;

		// Uncomment the following line if AJAX validation is needed
		// $this->performAjaxValidation($model);

		if(isset($_POST['Publicidadtips']))
		{
			$model->attributes=$_POST['Publicidadtips'];
	...
	{
		$model=new Publicidadtips('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['Publicidadtips']))
			$model->attributes=$_GET['Publicidadtips'];
	 ...
	 * @return Publicidadtips the loaded model
	 * @throws CHttpException
	 */
	public function loadModel($id)
	{
		$model=Publicidadtips::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param Publicidadtips $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='publicidadtips-form')
		{
