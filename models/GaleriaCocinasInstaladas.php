...
/**
 * This is the model class for table "galeria_cocinas_instaladas".
 *
 * The followings are the available columns in table 'galeria_cocinas_instaladas':
 ...
 */
class GaleriaCocinasInstaladas extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return GaleriaCocinasInstaladas the static model class
	 */
	...
	{
		return 'galeria_cocinas_instaladas';
	}
