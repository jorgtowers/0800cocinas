...
/**
 * This is the model class for table "publicidadinicio".
 *
 * The followings are the available columns in table 'publicidadinicio':
 ...
 */
class Publicidadinicio extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return Publicidadinicio the static model class
	 */
