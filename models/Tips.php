...
class Tips extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('contenido, activo, created, modified', 'required'),
			array('activo', 'numerical', 'integerOnly'=>true),
			array('contenido', 'length', 'max'=>255),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('idtip, contenido, activo, created, modified', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('idtip',$this->idtip);
