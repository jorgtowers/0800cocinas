...
/**
 * This is the model class for table "galeria_proyecto_cocinas".
 *
 * The followings are the available columns in table 'galeria_proyecto_cocinas':
 ...
 */
class GaleriaProyectoCocinas extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return GaleriaProyectoCocinas the static model class
	 */
	...
	{
		return 'galeria_proyecto_cocinas';
	}
